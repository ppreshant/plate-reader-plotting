...
1. Takes plate reader output excel file (`.xlsx`)
   ...
   - You could also shorten a table using wildcards : "**all**" for all columns or "**[x-y]**" for ranges for both rows and columns with single digits (ex: [1-3] (only single digits 0-9 allowed) or [C-F])  <img src="https://user-images.githubusercontent.com/14856479/211264019-91bf699f-8a2f-4e39-8cb4-663a4045573d.png" width = 200>

---
title: "Plate reader plotting : S023"
author: "Prashant"
date: "Feb 18, 2019"
...
MG1655_baseline <- all_days_table %>% filter(str_detect(Reporter, 'MG1655'), Time == 3) # MG1655 fluor values on day 3
...
all_days_table %<>% filter(!str_detect(Reporter, 'LB|MG')) # filter out LB and MG1655 from plotting

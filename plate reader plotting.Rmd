...
```{r plotting14}
sel_table14 <- all_days_table %>% group_and_summarize_at('GFP/OD') %>% 
...
plt14 <- plot_dose_response(sel_table14) + geom_line(data = hill_table14, aes(x = L, y = .fitted), linetype = 2) + aes(colour = factor(Time))

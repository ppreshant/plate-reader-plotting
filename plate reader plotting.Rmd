...
```{r plotting1}
sel_table1 <- all_days_table %>% group_and_summarize_at('GFP/OD') %>% filter(!str_detect(Samples, "pInt| Controls")) # filter neccesary samples for plotting ; by default mean and variance of GFP/RFP column

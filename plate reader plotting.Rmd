---
title: "Plate reader plotting : S013b : pPK6.2 RBS library"
author: "Prashant"
date: "July 9, 2019"
...
merged2 %<>% mutate('GFP/RFP' = GFP/RFP, 'GFP/OD' = GFP/OD, 'RFP/OD' = RFP/OD) %>% separate(Samples, c('Samples', NA), sep ='\\+') # calculate ratios and # remove the common reporter plasmid name after the + sign

...
plt11 <- plot_dose_response(sel_table11) + geom_line(data = hill_table11, aes(x = L, y = .fitted), linetype = 2) + geom_ribbon(data = hill_table11, aes(x = L, ymin = `.fitted` - .resid^2, ymax = `.fitted` + `.resid`))

...
plt_all_fluor <- ggplot(data = long_fluor.normalized_processed,
  ...
  ggtitle(str_c('Fluorescence measurement', if(MEFL_normalization) ' : in MEFL (uM)' ),
          subtitle = 'Plasmids')
  
  plt_all_fluor_annotated <- {plt_all_fluor + geom_text(data = long_unique.normalized_processed,  
...
map(FPs, plot_raw_static_fluorescence)
